...
| ----- |:-------------|:-----|
| R001 | 50-1000 Devices | In 2014 we see about 1 to 4 IP addresses/devices per user thus we are building for organisations with a minimum of 10 users and a maximum of 1000 however we could see up to 2500 devices in a medium network thus this shall be our notional upper bound for larger pods. |
