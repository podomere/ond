...
| 42 | 10.0.42.0/26 | Team A  Appliances/Users (if Server Network 1 not used) |
| 1042 | 10.0.42.64/26 | Team A VoIP Phones  (if Server Network 1 not used)| 
| 2042 | 10.0.42.128/26 | Team B  Appliances/Users (if Server Network 1 not used)  |
| 3042 | 10.0.42.196/26 | Team B VoIP Phones  (if Server Network 1 not used)| 
| 43 | 10.0.43/24 | Server Network 2 (if Team C+D not used) |
| 43 | 10.0.43.0/26 | Team C  Appliances/Users (if Server Network 2 not used) |
| 1043 | 10.0.43.64/26 | Team C VoIP Phones  (if Server Network 2 not used)| 
| 2043 | 10.0.43.128/26 | Team D  Appliances/Users (if Server Network 2 not used)|
| 3043 | 10.0.43.196/26 | Team D VoIP Phones  (if Server Network 2 not used)| 
| 44 | 10.0.44/24 | Server Network 3 (if Team E+F not used) |
| 44 | 10.0.44.0/26 | Team E  Appliances/Users (if Server Network 3 not used)|
| 1044 | 10.0.44.64/26 | Team E VoIP Phones (if Server Network 3 not used) | 
| 2044 | 10.0.44.128/26 | Team F  Appliances/Users (if Server Network 3 not used)|
| 3044 | 10.0.44.196/26 | Team F VoIP Phones (if Server Network 3 not used)| 
| 45 | 10.0.45/24 | Server Network 4 (if Team G+H not used) |
| 45 | 10.0.45.0/26 | Team G  Appliances/Users (if Server Network 4 not used)|
| 1045 | 10.0.45.64/26 | Team G VoIP Phones (if Server Network 4 not used)| 
| 2045 | 10.0.45.128/26 | Team H  Appliances/Users (if Server Network 4 not used)|
| 3045 | 10.0.45.196/26 | Team H VoIP Phones (if Server Network 4 not used)| 
...
If possible via the vendors radio settings, disable all speeds and MCS indices
