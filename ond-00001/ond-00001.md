# Network Pod Design for Small to Medium Sized Organisations
## Introduction
...
## Simple High Level Mixed Requirements
...
So an example for the first firewall on level 2 of a building in Berlin, Germany for the organisation 'Mitose' would be:  ```de-ber-mit-fw02a.mit.mitose.com```. There are many approaches to this so this is just to be considered a helpful hint.
