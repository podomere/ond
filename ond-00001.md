...
<img src="images/ond-smb-network-pods-v2.jpg" width=935px></img>
...
| Device A Port ID | A Presentation | Cable Type | Patch X ID | Patch Y ID | Cable Type | B Presentation | Device B Port ID |
| ------------- |-------------| -----| -----| --- | ---- |
| g1 | SFP+ | MMF(OM3) | A1.1 | R1.7 | Cat5e | RJ45 | g1 |
| g2 | SFP+ | MMF(OM3) | A1.2 | R1.8 | Cat5e | RJ45 | g2 |
| g3 | RJ45 | MMF(OM3) | B1.1 | S2.7 | Cat5e | RJ45 | g3 |
| g4 | RJ45 | MMF(OM3) | B1.2 | S2.8 | Cat5e | RJ45 | g4 |
| g5 | SFP+ | SM | C1.1 | T1.1 | SM | RJ45 | g5 |
| g6 | SFP+ | SM | C1.2 | T1.2 | SM | RJ45 | g6 |

**Note:** Where the patch can be a ToR(Top of Rack) copper or fibre patch panel. Sometimes you will hear the terms IDF(Intermediate Distribution Frame) or MDF(Main Distribution Frame) in relation to the infrastructure cabling. If you are using fibre you may hear the terms ODF(Optical Distribution Frame) or 
